...
<input type="button" name="" value="submit" onclick="display_attendance_parent()" class="btn btn-info"></div>
<div  class="col-md-5 "  style="margin: 10px;">
...
Semester
    <select name="semester" id="semester" onchange="display_attendance_by_sem_parent()">
