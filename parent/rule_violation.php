...
<li><a href="../logout.php" class="effect-3">Logout</a></li>
 ...
 // code to create object of class dboperations
    ...
    $sql="select * from tbl_rule_violation as e inner join tbl_rules as an on e.rule_id=an.rule_id   where e.student_login_id=(select student_login_id from tbl_parent_reg where login_id=$slogid)";
       $res1=$db->execute($sql);
...
<table  class="table table-striped">
    ...
    <tr>
     <td><?php echo $count1 ?></td>
      <td><?php echo $r1['rule_name'] ?></td>
      <td><?php echo $r1['description'] ?></td>
     <td><?php echo $r1['fine'] ?></td>
 <td><?php echo $r1['date_fine'] ?></td>
 </tr>
	<?php
	$count1++;
	}
