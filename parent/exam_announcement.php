...
<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Feedback<span class="caret"></span></a>
 ...
 // code to create object of class dboperations
   ...
   $sql="select * from tbl_exam_announce as an inner join tbl_staff_reg as s on an.teacher_login_id=s.login_id inner join tbl_subject su on an.subject_id=su.subject_id inner join tbl_semester sem on sem.semester_id=su.semester_id inner join tbl_student_reg as st on sem.semester_id=st.semester_id where st.login_id=(select student_login_id from tbl_parent_reg where login_id=$slogid) and an.exam_date >= DATE(NOW() - INTERVAL 3 DAY) + INTERVAL 0 SECOND";
       $res1=$db->execute($sql);
