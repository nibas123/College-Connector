...
<form name="f1" method="post" action="process_teacher_feedback.php">
 <table class="table">
...
$db=new dboperation();
$sq="select tbl_staff_reg.* from tbl_staff_reg inner join tbl_alott_staff on tbl_alott_staff.teacher_login_id=tbl_staff_reg.login_id inner join tbl_subject on tbl_subject.subject_id=tbl_alott_staff.subject_id inner join tbl_semester on tbl_semester.semester_id=tbl_subject.semester_id inner join tbl_student_reg on tbl_student_reg.semester_id=tbl_semester.semester_id inner join tbl_parent_reg on tbl_parent_reg.student_login_id=tbl_student_reg.login_id where tbl_parent_reg.login_id='$login_id'";
  ...
  <label>
    <select name="teacher_name" id="teacher_name" required="">
	  ...
	  while($r1=mysqli_fetch_array($res))
	  {
	   ...
	   ?>
        <option value="<?php echo $r1['login_id'] ?>"><?php echo $r1['first_name']." ".$r1['last_name'] ;?></option>
        <?php
	  }
	   ?>
      </select>
    ...
    <tr>
      ...
      <td>Feedback </td>
      <td><label>
<textarea name="feedback" type="text" id="feedback" required=""></textarea> 
      </label></td>
    </tr>
...
$count=1;
  ...
  $sql="select * from tbl_parent_teacher_feedback inner join tbl_staff_reg on tbl_staff_reg.login_id=tbl_parent_teacher_feedback.staff_id where parent_login_id='$slogid'";
$res=$db->execute($sql);
