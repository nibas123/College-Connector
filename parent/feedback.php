...
<li class="active"><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Feedback<span class="caret"></span></a>
...
$count=1;
  ...
  $sql="select * from tbl_feedback where parent_login_id='$slogid'";
$res=$db->execute($sql);
