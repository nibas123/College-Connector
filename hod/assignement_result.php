...
<li class="active"><a href="assignement_result.php" class="effect-3">Assignment Result</a></li>
...
?>	
<form name="f1" method="post" action="process_assignment_result.php" enctype="multipart/form-data">
...
<select name="student" id="student">
  ...
  <tr>
    <td>Subject Name </td>
    <td><label>
      <select name="subject_name" id="subject_name" onchange="display_topic1()">
	  <option value="0">..select..</option>
  ...
  <tr>
    <td>Topic</td>
    <td><select name="topic" id="topic" onchange="display_out_of_mark1()">
    	<option value="0">--Select--</option>
    </select></td>
  </tr>
  <tr>
...
$res=$user->select_assign_result_by_login_id($login_id);
	$count1=1;
