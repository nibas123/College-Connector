...
<li  class="active"><a href="change_semester.php" class="effect-3">Change Semester</a></li>
		...
		<div class="container">
			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="w3layouts_mail_grid">
						...
						<div class="col-md-8 wthree_contact_left_grid" style="">
							<h2>Change to Next Semester</h2>
	<?php
...
?>	
<form name="f1" method="post" action="process_change_semester.php" enctype="multipart/form-data">
