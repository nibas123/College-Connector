			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="w3layouts_mail_grid">
						...
						<div class="col-md-8  " style="margin:auto; text-align: center;">
							...
							<h2>Today's (<?php echo date('l');?>) Time Table </h2>
	<?php
$login_id=$_SESSION['login_id'];
include_once("query.php");
$user=new query();

$res1=$user->select_time_table($login_id);
...
<?php 
	  ...
	  {
	   ?><tr><td>
      <a href="mark_attendace.php?alot_id=<?php echo $r1["alott_id"]; ?>" class="btn btn-primary"><b>Course:</b><?php echo $r1["course_name"]; ?>&nbsp;&nbsp;&nbsp;<b>Semester:</b><?php echo $r1["semester_name"]; ?>&nbsp;&nbsp;&nbsp;<b>Subject:</b> <?php echo $r1["subject_name"]; ?>&nbsp;&nbsp;&nbsp;<b>Day: </b><?php echo $r1["day"]; ?>&nbsp;&nbsp;&nbsp;<b>Period:</b> <?php echo $r1["time_period"]; ?></a>  </td></tr>
        <?php
	  }
	   ?>
