...
{ 
	...
	<div class="agileits_top_menu">
		...
		<li class="active"><a href="assign_teacher.php" class="effect-3">Assign Teacher</a></li>
...
?>	
<form name="f1" method="post" action="process_assign_teacher.php">
<p align="left" style="margin-left: 20">&nbsp;</p>				
 <table>
  ...
  <td>Department </td>
    <td><label>
    <select name="department_name" id="department_name" onchange="display_course1()">
...
<select name="semester" id="semester" onchange="display_subject()">
  ...
  <tr>
    <td colspan="2" align="center"><label>
      <input type="submit" name="Submit"  value="submit" class="operations" onClick="return validate_assignn()">
    </label></td>
    </tr>
</table>
</form>
...
$res=$user->select_alott_staff($login_id);
	$count1=1;
  ...
  ?>
    ...
    <tr>
     <td><?php echo $count1 ?></td>
      ...
      <td><?php echo $r4['time_period'] ?></td>
        <td><?php echo $r4['day'] ?></td>
      <td><a class="operations" href="process_delete_alot_teacher.php?id=<?php echo $r4['alott_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count1++;
  }
