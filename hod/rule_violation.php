...
<li><a href="change_semester.php" class="effect-3">Change Semester</a></li>
								...
								<li class="active"><a href="rule_violation.php" class="effect-3">Rule Violation</a></li>
...
?>	
<form name="f1" method="post" action="process_rule_violation.php" enctype="multipart/form-data">
...
<select name="student" id="student">
  ...
  <td>Rule </td>
    <td><label>
    <select name="rule" id="rule" onchange="display_amount()">
      <option value="0">-- Select --</option>
       <?php
	  while($r1=mysqli_fetch_array($res2))
	  {
	   ?>
        <option value="<?php echo $r1['rule_id'] ?>"><?php echo $r1['rule_name'] ?></option>
        <?php
	  }
	   ?>
      </select>
  ...
  <tr>
    <td>Fine</td>
    <td><input type="text" name="fine" readonly="" id="fine"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="center"><label>
      <input type="submit" name="Submit"  value="submit" class="operations" onClick="return validate_rule_violation()">
    </label></td>
    </tr>
</table>
</form>
...
$res=$user->select_rule_violation_staff($logid);
	$count1=1;
  ...
  ?>
    ...
    <td><?php echo $r4['rule_name'] ?></td>
    <td><?php echo $r4['description'] ?></td>
    
      <td><?php echo $r4['first_name']." ".$r4['last_name'] ?></td>
      <td><?php echo $r4['fine']?></td>
