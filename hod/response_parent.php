...
<li  class="active"><a href="feedback.php" class="effect-3">Feedback</a></li>
...
<form name="f1" method="post" action="process_response_parent.php">
 <table class="table">
    <tr>
...
<textarea name="response" type="text" id="response"></textarea> 
    ...
    <tr>
      <td colspan="2" align="center"><input type="hidden" name="feedback_id" value="<?php echo $_GET['id']; ?>">
