...
$count=1;
  ...
  $sql="select * from tbl_parent_teacher_feedback  inner join tbl_parent_reg on tbl_parent_teacher_feedback.parent_login_id=tbl_parent_reg.login_id inner join tbl_student_reg on tbl_student_reg.login_id=tbl_parent_reg.student_login_id where tbl_parent_teacher_feedback.response='Nill' and tbl_parent_teacher_feedback.staff_id='$slogid' ";
$res=$db->execute($sql);
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      ...
      <td><?php echo $r['response'] ?></td>
       <td>
    <a class="btn btn-success" href="response_parent.php?id=<?php echo $r['feedback_id'] ?>">Response</a>
     </td>
    </tr>
    <?php
	$count++;
