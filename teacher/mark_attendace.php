			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="w3layouts_mail_grid">
						...
						<div class="col-md-6" style="margin:auto; text-align: center;">
							...
							<h2>Student List (<?php echo date('l');?>)  </h2>
	<?php
$login_id=$_SESSION['login_id'];
include_once("query.php");
$user=new query();
$alott_id=$_GET["alot_id"];
$res1=$user->select_list_student($alott_id);
...
<table  class="table table-striped">
   ...
   <td><a class="btn btn-primary" href="present.php?login_id=<?php echo $r1['login_id'] ?>&alott_id=<?php echo $alott_id ?>">Present</a></td>
        <td><a class="btn btn-primary" href="absent.php?login_id=<?php echo $r1['login_id'] ?>&alott_id=<?php echo $alott_id ?>">Absent</a></td>
    </tr>
	<?php
	}
	?>
						...
						<div class="col-md-5  ">
								...
								<h2>Attendance Today(<?php echo date('l');?>)  </h2>
	<?php
$login_id=$_SESSION['login_id'];
include_once("query.php");
$user=new query();
$alott_id=$_GET["alot_id"];
$res1=$user->select_attendane_today($alott_id);
