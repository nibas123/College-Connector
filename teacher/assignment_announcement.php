...
{ 
	...
	<div class="agileits_top_menu">
		...
		<li><a href="attendance.php" class="effect-3">Attendance</a></li>
								...
								<li class="active"><a href="assignment_announcement.php" class="effect-3">Assignment</a></li>
...
?>	
<form name="f1" method="post" action="process_assignment_announcement.php" enctype="multipart/form-data">
<p align="left" style="margin-left: 20">&nbsp;</p>				
 <table>
  ...
  <tr>
      <td>Semester Name </td>
      <td><label>
<select name="semester" id="semester" onchange="display_subject()">
       <option value="0">-- Select --</option>
  ...
  <tr>
   ...
   <tr>
    <td>Out of Mark</td>
    <td><input type="text" name="out_mark" id="out_mark"></td>
  </tr>
  <tr>
    <td>End Date</td>
  ...
  <tr>
    <td colspan="2" align="center"><label>
      <input type="submit" name="Submit"  value="submit" class="operations" onClick="return validate_assign_result()">
    </label></td>
    </tr>
</table>
</form>
...
$res=$user->select_assign_by_login_id($login_id);
	$count1=1;
  ...
  ?>
    ...
    <tr>
     ...
     <td><?php echo $r4['assign_date'] ?></td>
     <td><?php echo $r4['out_of_mark'] ?></td>
      <td><a class="btn btn-primary" href="process_delete_assignment.php?id=<?php echo $r4['assign_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count1++;
  }
