...
<li class="active"><a href="note.php" class="effect-3">Note</a></li>
...
<select name="semester" id="semester" onchange="display_subject()">
  ...
  <tr>
    <td colspan="2" align="center"><label>
      <input type="submit" name="Submit"  value="submit" class="operations" onClick="return validate_note()">
    </label></td>
    </tr>
</table>
</form>
...
$res=$user->select_notes_by_login_id($login_id);
	$count1=1;
  ...
  ?>
    ...
    <tr>
     ...
     <td><?php echo $r4['title'] ?></td>
      ...
      <td><a class="btn btn-primary" href="process_delete_notes.php?id=<?php echo $r4['note_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count1++;
  }
