...
{ 
	...
	<div class="agileits_top_menu">
		...
		<li><a href="attendance.php" class="effect-3">Attendance</a></li>
								<li class="active"><a href="exam_announcement.php" class="effect-3">Exam</a></li>
...
?>	
<form name="f1" method="post" action="process_exam_announcement.php" enctype="multipart/form-data">
...
<select name="semester" id="semester" onchange="display_subject()">
  ...
  <tr>
    <td colspan="2" align="center"><label>
      <input type="submit" name="Submit"  value="submit" class="operations" onClick="return validate_exam_announce()">
    </label></td>
    </tr>
</table>
</form>
...
$res=$user->select_exam_by_login_id($login_id);
	$count1=1;
  ...
  ?>
    ...
    <tr>
     ...
     <td><?php echo $r4['exam_date'] ?></td>
      ...
      <td><a class="btn btn-primary" href="process_exam.php?id=<?php echo $r4['exam_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count1++;
  }
