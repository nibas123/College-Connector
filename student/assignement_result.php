...
<li><a href="fee.php" class="effect-3">Fee</a></li>
 ...
 // code to create object of class dboperations
   ...
   $sql="select * from tbl_assignment_result as e inner join tbl_assignment as an  on e.assign_id=an.assign_id  inner join tbl_staff_reg as s on an.teacher_login_id=s.login_id inner join tbl_subject su on an.subject_id=su.subject_id inner join tbl_semester sem on sem.semester_id=su.semester_id inner join tbl_student_reg as st on sem.semester_id=st.semester_id where st.login_id=$slogid";
       $res1=$db->execute($sql);
