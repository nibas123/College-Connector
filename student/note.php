...
<li><a   class="active" href="note.php" class="effect-3">Note</a></li>
   ...
   <tr class="alert alert-info">
	...
	?>
     ...
     <td><?php echo $r1['entry_date'] ?></td>
      <td><a class="btn btn-primary" href="../notes/<?php echo $r1['note_name'] ?>">Download</a></td>
	<?php
	}
	?>
  </table>
