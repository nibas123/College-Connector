...
<form name="f1" method="post" action="process_update_semester1.php">
	 <table  class="table table-striped">
  
   
    <tr>

    <td colspan="2" align=""><h4> Update Semester</h4></td></tr><tr>
    	
      <tr>
    <td>Fee</td>
    <td><label>
      <input type="text" name="fee" id="fee" required="" value="<?php echo $fee_amount;?>"> 
    </label></td>
