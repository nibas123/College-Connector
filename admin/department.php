					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="department.php" class="effect-3">Department</a></li>
		...
		<div class="container">
			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="w3layouts_mail_grid">
						...
						<form name="f1" method="post" action="process_add_deparatment.php">
  <table class="table">
    <tr>
    <td colspan="2" align="center"><h4> Add Department</h4></td></tr><tr>
      <td>Department</td>
      <td><label>
      ...
      <td colspan="2" align="center">
        <input style="width:50%" class="operations" type="submit" name="Submit" value="Submit" onClick="return validate_department()">
     </td>
    </tr>
  </table>
 ...
 ?>
  ...
  ?>
    <tr  class=ros<?php echo  $count%2; ?>>
      ...
      <td><a class="operations" href="process_delete_department.php?id=<?php echo $r['department_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count++;
  }
