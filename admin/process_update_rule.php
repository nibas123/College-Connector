...
<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Feedback<span class="caret"></span></a>
										<ul class="dropdown-menu">
											<li><a class="hvr-bounce-to-bottom" href="Feedback.php">Student</a></li>
		...
		<div class="container">
			...
			<div class="inner_sec_grids_info_w3ls">
				...
				<div class="w3layouts_mail_grid">
						...
						<div class="col-md-8">
	<h3 class="heading-agileinfo">Rule<span>Update Rule Here</span></h3>
					 <?php
					 $rid=$_GET['id'];
include_once("query.php");
$user=new query();
$res=$user->select_rules($rid);
while($r=mysqli_fetch_array($res))
  {
 ?>

<center>
<form name="f1" method="post" action="process_update_rule_action.php">
    <table>
    <tr>
    <td colspan="2" align="center"></td></tr><tr>
      <td>Rule Name </td>
      <td><label>
        <input name="rule_name" type="text" id="rule_name" value="<?php echo  $r['rule_name'] ?>">
      </label></td>
    </tr>
    <tr>
      <td>Description</td>
      <td><textarea name="description" id="description" value="<?php echo $r['description'] ?>"><?php echo $r['description'] ?></textarea></td>
    </tr>
    <tr>
      <td>Fine</td>
      <td><label>
        <input name="fine" type="text" id="fine" value="<?php echo $r['fine'] ?>">
      </label></td>
      <input type="hidden" name="rid" value="<?php echo $r['rule_id']?>">
    </tr>
    <tr>
