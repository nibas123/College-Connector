...
<li class="active"><a href="hod.php" class="effect-3">HOD</a></li>
...
<li><a href="#" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Feedback<span class="caret"></span></a>
										<ul class="dropdown-menu">
											...
											<li class="active"><a class="hvr-bounce-to-bottom" href="faculty_feedback.php">Faculty</a></li>          
										</ul></li>
<li><a href="feedetails.php" class="effect-3">Fee</a></li>
	...
	<div class="inner_content_info_agileits">
		...
		<h3 class="heading-agileinfo">Assign HOD<span>HOD Here</span></h3>				
 <?php
...
<form name="f1" method="post" action="process_hod.php">
 <table class="table">

     <tr>
      <td>Department</td>
      <td><select name="txtdpt" id="txtdpt" onchange="display_teachers()">
	   ...
	   while($row=mysqli_fetch_array($res1))
  {
    ...
    <tr>
      <td>Teacher</td>
      <td><select name="teacher" id="teacher" ><option value="0">--select--</option>
      </select></td></tr>
    <tr>
      <td colspan="2" align="center">
        <input style="width:50%" class="operations" type="submit" name="Submit" value="Submit" onClick="return validate_hod()">
     </td>
    </tr>
  </table>
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      ...
      <td><?php echo $r['department_name'] ?></td>
        <td><?php echo $r["first_name"]." ". $r["last_name"]." ". $r["address"]?></td>
      <td><a class="operations" href="process_delete_hod.php?id=<?php echo $r['hod_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count++;
  }
