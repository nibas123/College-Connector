...
<li><a href="approve_user.php" class="effect-3">Approve User</a></li>
	<li  class="active"><a href="add_weightage.php" class="effect-3">Weightage</a></li>	
...
<form name="f1" method="post" action="process_add_weightage.php">
 <table class="table">
    <tr>

      <td>Weightage </td>
      <td><label>
<input name="Weightage" type="text" id="Weightage">
      </label></td>
    </tr>
...
<input style="width:50%" class="operations" type="submit" name="Submit" value="Submit" onClick="return validate_weightage()">
     </td>
    </tr>
  </table>
...
$res=$user->select_weightage();
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      <td><?php echo $r['weightage'] ?></td>
      <td><?php echo $r['type'] ?></td>
    
      <td><a class="operations" href="process_delete_weightage.php?id=<?php echo $r['weightage_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count++;
  }
