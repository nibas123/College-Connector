...
<li class="active"><a href="approve_user.php"  class="effect-3">Approve User</a></li>
...
$user=new query();
$res=$user->select_staff_details();
$res1=$user->select_student_details();
 ?>
  ...
  <tr>
   <tr class="toptrtbl">
    ...
    <td><?php echo $r['qualification'] ?></td>
      ...
      <td><a class="operations" href="process_approve_staff.php?id=<?php echo $r['login_id'] ?>">Approve</a></td>
      <td><a class="operations" href="process_reject_staff.php?id=<?php echo $r['login_id'] ?>">Reject</a></td>
    </tr>
	<?php
	$count++;
	} ?></table>
  ...
  ?>
    ...
    <tr  class=ros<?php echo  $count1%2; ?>>
     <td ><?php echo $count1++; ?></td>
      ...
      <td><a class="operations" href="process_approve_student.php?id=<?php echo $r1['login_id'] ?>">Approve</a></td>
      <td><a class="operations" href="process_reject_student.php?id=<?php echo $r1['login_id'] ?>">Reject</a></td>
    </tr>
	<?php
	}
	?>
