...
{ 
	...
	<li  class="active"><a href="subject.php" class="effect-3">Subject</a></li>
...
<form name="f1" method="post" action="process_add_subject.php">
 <table class="table">
    <tr>

    <td colspan="2" align="center"><h4> Add Subject</h4></td></tr><tr>
    	<tr>
    <td>Department </td>
    <td><label>
  ...
  <tr>
    ...
    <tr>
      <td colspan="2" align="center">
        <input style="width:50%" class="operations" type="submit" name="Submit" value="Submit" onClick="return validate_subject()">
     </td>
    </tr>
  </table>
    ...
    <?php 
    $res2=$user->select_subject_details();
	$count=1;
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      ...
      <td><a class="operations" href="process_delete_subject.php?id=<?php echo $r['subject_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count++;
  }
