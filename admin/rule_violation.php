...
?>	
						...
						<div class="col-md-12 wthree_contact_left_grid">
							<h3 class="heading-agileinfo">Rule Violation<span>List</span></h3>
...
$res=$user->select_rule_violation();
	$count1=1;
...
<?php $s=$r4['stud_reg_id']; ?>
     
     	<?php
     	 $sql00="select * from tbl_student_reg where stud_reg_id='$s'";
		$db=new dboperation();
		$res00=$db->execute($sql00);
while($r400=mysqli_fetch_array($res00))
  {?>
 <td><?php echo $r400['first_name']." ".$r400['last_name'] ?></td>
  <?php }
?>
     </td>
