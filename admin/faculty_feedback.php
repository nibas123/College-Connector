...
$count=1;
  ...
  $sql="select * from tbl_faculty_feedback inner join tbl_staff_reg on tbl_faculty_feedback.login_id=tbl_staff_reg.login_id where response='Nill'";
$res=$db->execute($sql);
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      ...
      <td><?php echo $r['response'] ?></td>
       <td>
    <a class="btn btn-success" href="response_faculty.php?id=<?php echo $r['feedback_id'] ?>">Response</a>
     </td>
    </tr>
    <?php
	$count++;
