					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								...
								<li  class="active"><a href="course.php" class="effect-3">Course</a></li>
...
$user=new query();
$res=$user->select_course_dept();
$res1=$user->select_department();
 ?>
</p>

<form name="f1" method="post" action="process_add_course.php">
 <table class="table">
    <tr>
    <td colspan="2" align="center"><h4> Add Course</h4></td></tr><tr>
      <td>Course Name </td>
      <td><label>
 ...
 <input name="duration" type="text" id="duration">
     ...
     <tr>
      <td>Department</td>
      <td><select name="txtdpt" id="txtdpt"><option value="0">--select--</option>
      <?php
	   while($row=mysqli_fetch_array($res1))
  {
    ...
    <tr>
      <td colspan="2" align="center">
        <input style="width:50%" class="operations" type="submit" name="Submit" value="Submit" onClick="return validate_course()">
     </td>
    </tr>
  </table>
  ...
  ?>
    ...
    <td><?php echo$count ?></td>
      ...
      <td><a class="operations" href="process_delete_course.php?id=<?php echo $r['course_id'] ?>">Delete</a></td>
    </tr>
    <?php
	$count++;
  }
